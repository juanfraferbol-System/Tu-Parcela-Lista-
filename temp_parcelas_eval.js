module.exports = [
...

   {
    ...
    nombre:"Parcela cercada con linda vista sector Perigallo - Yumbel",

    precio:"$20.000.000",

    tamano:5000,

    lat:-37.04244276437281,
    lng:-72.64501423010334,

    imagen:"image/duenos/yumbel/pirigallo/pirigallo_(1).webp",

    imagenes:[
        "image/duenos/yumbel/pirigallo/pirigallo_(1).webp",
        "image/duenos/yumbel/pirigallo/pirigallo_(2).webp",
        "image/duenos/yumbel/pirigallo/pirigallo_(3).webp",
        "image/duenos/yumbel/pirigallo/pirigallo_(4).webp",
        "image/duenos/yumbel/pirigallo/pirigallo_(5).webp",
        "image/duenos/yumbel/pirigallo/pirigallo_(6).webp",
    ],

    descripcion:"Hermosa parcela de 5.000 m² ubicada en un entorno tranquilo de Yumbel. Se encuentra completamente cercada con portón de madera, limpia y lista para desarrollar un proyecto habitacional o de descanso. Destaca por su excelente vista panorámica y su entorno natural. La factibilidad eléctrica se encuentra en proceso de conexión y cuenta con Rol Propio.",
    ...
    distanciaConcepcion:"120 km",
    tiempoConcepcion:"2 h",

    comuna:"Yumbel",

    detalle:`
    • Superficie: 5.000 m².<br>
    • Rol propio.<br>
    • Terreno completamente cercado.<br>
    • Portón de madera instalado.<br>
    • Terreno limpio y despejado.<br>
    • Excelente vista panorámica.<br>
    • Factibilidad eléctrica en proceso.<br>
    • Ideal para vivienda, parcela de agrado o inversión.<br>
    • Entorno tranquilo y con buena conectividad.
    `,
...

{
    ...
    imagen:"image/nipas_venega/nipas_venegas (1).webp",

    imagenes:[
        "image/nipas_venega/nipas_venegas (1).webp",
        "image/nipas_venega/nipas_venegas (2).webp",
        "image/nipas_venega/nipas_venegas (3).webp",
        "image/nipas_venega/nipas (1).png",
        "image/nipas_venega/nipas (2).webp",
        "image/nipas_venega/nipas (3).webp",
    ],

    descripcion:"Parcelas de 5.000 m² ubicadas en el sector Lomas Coloradas de Ñipas, en pleno Valle del Itata. Un entorno natural con hermosas vistas, excelente clima y acceso cercano a la Ruta del Itata, ideal para quienes buscan tranquilidad, descanso o desarrollar un proyecto de vida en el campo. Cuentan con Rol Propio y factibilidad eléctrica.",
    ...
    detalle:`
    • Parcelas de 5.000 m².<br>
    • Rol propio.<br>
    • Factibilidad eléctrica disponible.<br>
    • Excelente clima durante gran parte del año.<br>
    • Hermosas vistas al entorno rural del Valle del Itata.<br>
    • Acceso cercano a la Ruta del Itata.<br>
    • Terrenos ideales para vivienda, segunda residencia o inversión.<br>
    • Entorno tranquilo, seguro y con gran proyección.<br>
    • A pocos minutos del centro de Ñipas.
    `,
 ...
 
 {
    ...
    id:"el_roble",
    nombre:"El Roble Nativo – Nacimiento",
    precio:"$6.690.000",
    tamano:5000,
    lat:-37.54761,
    lng:-72.94834,
    imagen:"image/nacimiento/nac_el_roble/el_roble (5).webp",
    imagenes:[
        "image/nacimiento/nac_el_roble/el_roble (5).webp",
        "image/nacimiento/nac_el_roble/el_roble (1).webp",
        "image/nacimiento/nac_el_roble/el_roble (2).webp",
        "image/nacimiento/nac_el_roble/el_roble (3).webp",
        "image/nacimiento/nac_el_roble/el_roble (4).webp",
        "image/nacimiento/nac_el_roble/el_roble (6).webp",
        "image/nacimiento/nac_el_roble/el_roble (7).webp",
    ],
    descripcion:"Parcela de 5.000 m² ubicada en el sector El Roble, comuna de Nacimiento, en un entorno natural asociado a la Cordillera de Nahuelbuta. Ideal para quienes buscan tranquilidad, vegetación nativa y un proyecto de descanso o inversión en la Región del Biobío. La zona de Nahuelbuta destaca por su biodiversidad, presencia de bosque nativo y paisajes de alto valor natural. Actualmente quedan solo dos parcelas disponibles en este proyecto.",
    luz:"no",
    agua:"no",
    naturaleza:"si",
    rol:"si",
    ...
    tiempoConcepcion:"2 h",
    comuna:"Nacimiento",
    detalle:"Los_Robles.html",
    facilidad:"si"
},
 
   {
    id:"chequenal_parcela_13",
    nombre:"Chequenal Nativo – Parcela 13 | Nacimiento",
    precio:"$13.658.000",
    tamano:5000,
    lat:-37.365243,
    lng:-72.723828,
    imagen:"image/nacimiento/nac_cheque_12/nac_chequenal_129_ (2).webp",
    imagenes:[
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (2).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (1).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (3).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (4).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (5).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (6).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (7).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (8).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (9).webp",
        "image/nacimiento/nac_cheque_12/nac_chequenal_129_ (10).webp"
    ],
    descripcion:"Parcela de 5.000 m² ubicada en el sector Chequenal, comuna de Nacimiento, rodeada de un agradable entorno natural característico del Biobío. Cuenta con factibilidad de energía eléctrica y Rol Propio, convirtiéndose en una excelente alternativa para construir una vivienda, una segunda residencia o desarrollar un proyecto familiar. Su ubicación permite disfrutar de tranquilidad, privacidad y contacto permanente con la naturaleza, manteniendo una conveniente conexión con la ciudad de Nacimiento.",
    agua:"no",
    naturaleza:"si",
    rol:"si",
    luz:"si",
...

{
    ...
    destacada:"si",
    comuna:"Nacimiento",
    detalle:"chequenal_44.html",
    facilidad:"si"
},

  {
    id:"santa_ana_media_hectarea",
    nombre:"Santa Ana – 5.000 m² | Quillón",
    precio:"$8.490.000",
    tamano:5000,
    lat:-36.828756,
    lng:-72.522014,
    imagen:"image/eric_arrepol/huacamala/santa_ana_1.webp",
    imagenes:[
        "image/eric_arrepol/huacamala/santa_ana_1.webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (1).webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (2).webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (3).webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (4).webp",
        "image/eric_arrepol/huacamala/gps_arreglado.webp"
    ],

    descripcion:"Parcela de 5.000 m² ubicada en el sector Santa Ana, comuna de Quillón, Región de Ñuble. Una excelente oportunidad para quienes buscan tranquilidad, aire limpio y un entorno rural con buena conectividad. El terreno cuenta con Rol Propio y factibilidad de energía eléctrica, ofreciendo una base ideal para construir una vivienda permanente, una casa de descanso o desarrollar un proyecto familiar. Quillón es reconocido como uno de los principales destinos turísticos de la Región de Ñuble gracias a sus lagunas, viñas, gastronomía campestre y actividades recreativas durante todo el año. Desde esta ubicación es posible acceder fácilmente al centro de Quillón, donde encontrarás supermercados, centros de salud, colegios, bancos, restaurantes y todos los servicios necesarios para la vida diaria. Además, la comuna mantiene una creciente demanda por parcelas de agrado, convirtiéndose en una interesante alternativa de inversión con proyección de plusvalía. Si sueñas con vivir rodeado de naturaleza sin alejarte de los servicios esenciales, esta parcela reúne las condiciones para comenzar ese proyecto.",
    ...
    servicios:"no",
    destacada:"no",
    distanciaConcepcion:"55 km",
    tiempoConcepcion:"50 min",
    comuna:"Quillón",
    detalle:"Santa_Ana_media.html",
    facilidad:"no"
},

 {
    id:"florida_d2",
    nombre:"Las Ulloas – Parcela D2 | Florida",
    precio:"$24.360.000",
    tamano:5000,
    lat:-36.854346,
    lng:-72.764013,
    imagen:"image/samuel_florida/lote_d2/lote_d2_ (2).webp",
    imagenes:[
        "image/samuel_florida/lote_d2/lote_d2_ (2).webp",
        "image/samuel_florida/lote_d2/lote_d2_ (3).webp",
        "image/samuel_florida/lote_d2/lote_d2_ (4).webp",
        "image/samuel_florida/lote_d2/lote_d2_ (5).webp",
        "image/samuel_florida/lote_d2/lote_d2_ (6).webp",
        "image/samuel_florida/lote_d2/lote_d2_ (7).webp",
        "image/samuel_florida/lote_d2/lote_d2_ (8).webp",
        "image/samuel_florida/lote_d2/lote_d2_ (9).webp",
    ],
    video:"https://www.youtube.com/watch?v=E1aTYnBu4ug",

    descripcion:"Parcela de 5.000 m² ubicada en el sector Las Ulloas, comuna de Florida, Región del Biobío. Destaca por sus suelos fértiles, buena humedad natural y un entorno campestre ideal para desarrollar proyectos agrícolas, frutales, huertos o simplemente construir una vivienda rodeada de tranquilidad. El terreno cuenta con Rol Propio y factibilidad de energía eléctrica, ofreciendo excelentes condiciones para comenzar un proyecto de vida o inversión. La comuna de Florida es reconocida por su tradición agrícola y forestal, además de sus hermosos paisajes rurales y su cercanía a la Reserva Nacional Nonguén, uno de los principales pulmones verdes de la región. Su ubicación permite llegar al centro de Florida en aproximadamente 15 minutos y a Concepción en cerca de 35 minutos, facilitando el acceso a universidades, centros de salud, comercio y servicios. Una excelente oportunidad para quienes desean disfrutar de la vida de campo sin renunciar a la conectividad con la capital regional.",
    ...
    servicios:"no",
    destacada:"no",
    distanciaConcepcion:"38 km",
    tiempoConcepcion:"35 min",
    comuna:"Florida",
    detalle:"florida_d2.html",
    facilidad:"no"
},

{
    id:"los_guindos_media_hectarea",
    nombre:"Los Guindos Nativo – Bosque Nahuelbuta | Nacimiento",
    precio:"$9.578.000",
    tamano:5000,
    lat:-37.53577,
    lng:-72.94660,
    imagen:"image/nacimiento/los_guindos/los_guindos_89 _arreglada_.webp",
    imagenes:[
        "image/nacimiento/los_guindos/los_guindos_89_1 (1).webp",
        "image/nacimiento/los_guindos/los_guindos_89_1 (2).webp",
        "image/nacimiento/los_guindos/los_guindos_89_1 (3).webp",
        "image/nacimiento/los_guindos/los_guindos_89_gps.webp",
    ],

    descripcion:"Parcela de 5.000 m² ubicada en el sector Los Guindos, comuna de Nacimiento, inmersa en el privilegiado entorno de la Cordillera de Nahuelbuta, uno de los paisajes naturales más emblemáticos del sur de Chile. Rodeada de bosque nativo, esta propiedad ofrece un ambiente de absoluta tranquilidad, aire puro y una biodiversidad característica de la zona, donde predominan especies como robles, coigües, canelos y una variada fauna silvestre. Durante el invierno es posible apreciar heladas e incluso nevadas en sectores altos de la cordillera, entregando postales únicas a lo largo del año. La parcela cuenta con Rol Propio, siendo una excelente alternativa para desarrollar una segunda vivienda, una cabaña de montaña o un proyecto de ecoturismo. Su entorno invita a disfrutar de caminatas, fotografía de naturaleza, observación de aves y una verdadera desconexión del ritmo urbano. Si buscas invertir en un lugar con alto valor paisajístico y un entorno natural difícil de encontrar, Los Guindos representa una excelente oportunidad para construir tu proyecto de vida en plena naturaleza.",
...

{
    ...
    tiempoConcepcion:"35 min",
    comuna:"Florida",
    detalle:"Florida_c.html"
},

{
    id:"florida_b3",
    nombre:"Las Ulloas – Casa de Campo Premium | Florida",
    precio:"$150.000.000",
    tamano:11000,
    lat:-36.85471,
    lng:-72.76610,
    imagen:"image/samuel_florida/lote_b3_casa/florida_b3 (10).webp",
    imagenes:[
        "image/samuel_florida/lote_b3_casa/florida_b3 (10).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (1).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (2).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (3).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (4).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (5).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (6).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (7).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (8).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (9).webp",
        "image/samuel_florida/lote_b3_casa/florida_b3 (10).webp",
    ],

    descripcion:"Exclusiva propiedad ubicada en el sector Las Ulloas, comuna de Florida, que combina la tranquilidad del campo con una excelente conectividad hacia Concepción. Emplazada sobre un terreno de 11.000 m² (1,1 hectáreas), esta casa de campo se encuentra lista para disfrutar y ofrece amplios espacios exteriores ideales para la vida familiar, el descanso o el teletrabajo en un entorno natural. La vivienda dispone de dos habitaciones, cómoda cocina y espacios diseñados para disfrutar durante todo el año. En el exterior destacan una piscina y una tinaja, perfectas para compartir con familia y amigos, además de un amplio terreno con potencial para jardines, huertos, frutales, ampliaciones o la construcción de cabañas complementarias. La comuna de Florida es reconocida por su entorno agrícola, bosques nativos y su cercanía a la Reserva Nacional Nonguén, uno de los principales pulmones verdes de la Región del Biobío, ideal para senderismo, observación de aves y actividades al aire libre. A solo 35 minutos de Concepción, esta propiedad ofrece la posibilidad de vivir rodeado de naturaleza sin renunciar a la cercanía de universidades, centros de salud, comercio y servicios. Una excelente oportunidad para quienes buscan una casa de campo de alto estándar, una segunda vivienda o una inversión con proyección de valorización.",
...

{
    ...
    servicios:"no",
    destacada:"si",
    distanciaConcepcion:"105 km",
    tiempoConcepcion:"1 h 30 min",
    comuna:"Negrete",
    detalle:"negrete_vista_rio.html",
    facilidad:"si"
},

{
    id:"negrete_parcela_con_rio",
    nombre:"Ribera del Vergara – Acceso Privado al Río | Negrete",
    precio:"$36.200.000",
    tamano:5000,
    lat:-37.56553,
    lng:-72.63902,
    imagen:"image/negrete/negrete_con_ _rio_ (1).webp",
    imagenes:[
        "image/negrete/negrete_con_ _rio_ (1).webp",
        "image/negrete/negrete_rio_ (2).webp",
        "image/negrete/negrete_rio_ (3).webp",
        "image/negrete/negrete_rio_ (4).webp",
        "image/negrete/negrete_rio_ (5).webp"
...

{
    ...
    destacada:"si",
    comuna:"Pemuco",
    detalle:"Pemuco_campo.html"
},

{
    id:"santa_ana_campo",
    nombre:"Santa Ana de Quillón – Campo de 10 Hectáreas | Proyecto de Parcelación",
    precio:"$120.000.000",
    tamano:100000,
    lat:-36.831954,
    lng:-72.522757,
    imagen:"image/eric_arrepol/huacamala/gps_arreglado.webp",
    imagenes:[
        "image/eric_arrepol/huacamala/gps_arreglado.webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (1).webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (2).webp",
    ...
    destacada:"si",
    comuna:"Quillón",
    detalle:"Santa_Ana_quillon_campo.html"
},

{
    id:"santa_ana_6000mts2",
    nombre:"Santa Ana del Baúl – Parcela 6.000 m² | Quillón",
    precio:"$10.000.000",
    tamano:6000,
    lat:-36.82842,
    lng:-72.52133,
    imagen:"image/eric_arrepol/huacamala/Fotos_arregladas_ (4).webp",
    imagenes:[
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (4).webp",
        "image/eric_arrepol/huacamala/gps_arreglado.webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (1).webp",
    ...
    destacada:"no",
    comuna:"Quillón",
    detalle:"Santa_Ana_quillon_parcela_6m.html"
},

{
    id:"santa_ana_9500mts2",
    nombre:"Santa Ana del Baúl – Parcela Premium 9.500 m² | Quillón",
    precio:"$16.000.000",
    tamano:9500,
    lat:-36.82842,
    lng:-72.52133,
    imagen:"image/eric_arrepol/huacamala/Fotos_arregladas_ (2).webp",
    imagenes:[
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (2).webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (3).webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (4).webp",
    ...
    destacada:"no",
    comuna:"Quillón",
    detalle:"Santa_Ana_quillon_parcela_9m.html"
},

{
    id:"santa_ana_8000mts2",
    nombre:"Santa Ana del Baúl – Parcela Premium 8.000 m² | Quillón",
    precio:"$13.500.000",
    tamano:8000,
    lat:-36.831166,
    lng:-72.522963,
    imagen:"image/eric_arrepol/huacamala/Fotos_arregladas_ (3).webp",
    imagenes:[
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (3).webp",
        "image/eric_arrepol/huacamala/Fotos_arregladas_ (4).webp",
        "image/eric_arrepol/huacamala/gps_arreglado.webp",
...

{
    ...
    destacada:"si",
    comuna:"Nacimiento",
    detalle:"nacimiento_chequenal_ultimas.html",
    facilidad:"si"
},
{
    id:"caburgua",
    nombre:"Mirador del Villarrica – Parcela Premium | Caburgua",
    precio:"$200.000.000",
    tamano:5000,
    lat:-39.25332,
    lng:-71.79639,
    imagen:"image/cesar_Caburgua/cesar_caburgua_(5).webp",
    imagenes:[
        "image/cesar_Caburgua/cesar_caburgua_(5).webp",
    ...
    destacada:"si",
    comuna:"Caburgua",
    detalle:"PARCELAS/LOS LAGOS/Caburgua.html",
    facilidad:"no"
},

     {
    id:"campo_ruta_cabrero",
    nombre:"Ruta Concepción–Cabrero – Campo Estratégico 2 Hectáreas | Yumbel",
    precio:"$95.000.000",
    tamano:20000,
    agua:"no",
    luz:"si",
    ...
    detalle:"campo_ruta_cabrero.html",
    facilidad:"si"
},
