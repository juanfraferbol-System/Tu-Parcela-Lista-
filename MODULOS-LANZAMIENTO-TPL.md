...
| Partners | `/plataforma/partners/` | En pruebas | No | Desarrollo/admin | Alto | Cargar proveedores reales, contratos y proceso de verificación. | Etapa de crecimiento. |
...
- `js/launch-control.js` oculta Partners en el modo piloto.
- `_redirects` bloquea las rutas públicas de Partners y Manager legacy sin borrar su código.
